...
define config.name = _("MajorCrossroads")
...
Над игрой работали :
Маракулин Михаил(Программист)
Батуев Данил(ГеймДизайнер)
Сухоросова Елена(Дизайнер)
Яковлева Анастасия(Аналитик)
...
define build.name = "MajorCrossroads"
...
define config.save_directory = "MajorCrossroads-1699700864"
