...
define gui.insensitive_color = '#d9e0d9'
...
define gui.muted_color = '#f4f275'
define gui.hover_muted_color = '#f4f275'

## Цвета, используемые в тексте диалогов и выборов.
define gui.text_color = '#ffffff'
define gui.interface_text_color = '#ea4d54'
...
define gui.main_menu_background = Movie(play = "images/mainmenu1.ogv",loop = True, size = (1920,1080))
